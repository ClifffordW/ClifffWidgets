...
const body =
    ...
    <img class="bg-flair" src="https://items.kleientertainment.com/images/DST/PROFILEFLAIR_EYEBRELLAHAT_ROSE/verylarge">
    <img class="bg-portrait" src="https://items.kleientertainment.com/images/DST/PLAYERPORTRAIT_BG_EYEBRELLAHATROSE/verylarge">
    <img class="item-frame" src="https://clifffordw.github.io/ClifffWidgets/Drops/Dropcons/Frames/Item/default.png">
    <img class="bg-item" src="https://items.kleientertainment.com/images/DST/EYEBRELLAHAT_ROSE/verylarge">
