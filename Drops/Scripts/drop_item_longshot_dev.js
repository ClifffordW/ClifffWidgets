...
const body =
    ...
    <img class="bg-flair" src="https://items.kleientertainment.com/images/DST/PROFILEFLAIR_POTTEDFERN_COTL/verylarge">
    <img class="bg-portrait" src="https://items.kleientertainment.com/images/DST/PLAYERPORTRAIT_BG_POTTEDFERNCOTL/verylarge">
    <img class="item-frame" src="https://clifffordw.github.io/ClifffWidgets/Drops/Dropcons/Frames/Item/default.png">
    <img class="bg-item" src="https://items.kleientertainment.com/images/DST/POTTEDFERN_COTL/verylarge">
